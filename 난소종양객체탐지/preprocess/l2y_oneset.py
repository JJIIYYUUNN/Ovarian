...
class Labelme2YOLO_ONESET:
    '''Labelme to YOLO format converter'''
    '''Not Auto train_val_test split'''
    
    def __init__(self, json_dir, output_format, label_list, target):
    ...
    def _make_target_dir(self):
        ...
        for yolo_path in (os.path.join(self._label_dir_path + f'{self._target}/'),
                          os.path.join(self._image_dir_path + f'{self._target}/')):
    ...
    def convert(self):
        ...
        ori_json_names = [file_name for file_name in os.listdir(self._json_dir)
        ...
        with Pool(NUM_THREADS) as pool:
            for json_name in ori_json_names:
...
if __name__ == '__main__':
    ...
    # data_type = "초음파"
    label_input_path = "/home/data/2.라벨링데이터"
    png_input_path = "/home/data/1.원천데이터"
    save_path = f"/home/data/tmp_data"
    
    
    if data_type == "CT":
        convertor_1step = Label2Labelme(data_type, label_input_path, png_input_path, save_path)
        cancer_file_cnt, cancer_object_cnt, benign_file_cnt, benign_object_cnt = convertor_1step.change_label_structure()
        
    elif data_type == "초음파":
        convertor_1step = Label2Labelme(data_type, label_input_path, png_input_path, save_path, task = "tumor_type")
    ...
    convertor = Labelme2YOLO_ONESET(
            args.json_dir, args.output_format, args.label_list, 'test')
...
# cd /home/data
# python /home/src/preprocess/l2y_oneset.py --json_dir /home/data/tmp_data --label_list cancer benign --data_type CT 
# python /home/src/preprocess/l2y_oneset.py --json_dir /home/data/tmp_data --label_list 'Mature teratoma' 'Mucinous tumor' 'Serous tumor' 'Endometrioid tumor' 'Etc' --data_type 초음파
